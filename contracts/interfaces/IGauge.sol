...
interface IGauge {
    ...
    /// @notice Address of the token (TENEX) rewarded to stakers
    function rewardToken() external view returns (address);

    /// @notice Address of the FeesVotingReward contract linked to the gauge
    function feesVotingReward() external view returns (address);

    /// @notice Address of Tenex Voter
    function voter() external view returns (address);

    /// @notice Address of Tenex  Team
    function team() external view returns (address);

    /// @notice Returns if gauge is linked to a legitimate Tenex pool
