...
/// @title Tenex  ArtProxy
/// @author tenex.finance, @rncdrncd, @pegahcarter
/// @notice Official art proxy to generate Tenex veNFT artwork
contract VeArtProxy is IVeArtProxy {
    ...
    bytes8[5][10] palettes =
        ...
        [bytes8('#b48610'),'#123291','#cf3502','#3C4150','#A3A3A3'], //tenex
		    ...
		    bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "background_color": "121a26", "description": "Tenex Finance is a next-generation AMM that combines the best of Curve, Solidly and Uniswap, designed to serve as the Blast central liquidity hub. Tenex NFTs vote on token emissions and receive bribes and fees generated by the protocol.", "image": "data:image/svg+xml;base64,',
    ...
    /// @dev Calculates the number of digits before the "decimal point" in an NFT's veTENEX balance.
    ///      Input expressed in 1e18 format.
    function numBalanceDigits (uint256 _balanceOf) internal pure returns (int256 digitCount) {
        uint256 convertedveTENEXvalue = _balanceOf / 1e18;
        while (convertedveTENEXvalue != 0) {
            convertedveTENEXvalue /= 10;
            digitCount++;
        }
    }
    ...
    /// @dev Determines the number of lines in the SVG. NFTs with less than 10 veTENEX balance have zero lines.
