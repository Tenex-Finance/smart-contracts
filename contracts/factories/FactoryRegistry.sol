...
/// @title Tenex Factory Registry
/// @author Carter Carlson (@pegahcarter)
/// @notice Tenex Factory Registry to swap and create gauges
contract FactoryRegistry is IFactoryRegistry, Ownable {
    ...
    /// @dev Tenex protocol will always have a usable poolFactory, votingRewardsFactory, and gaugeFactory.  The votingRewardsFactory
