...
contract ManagedNftFlow is ExtendedBaseTest {
    ...
    function testSimpleManagedNftFlow() public {
        ...
        // create TENEX bribe for next epoch
        _createBribeWithAmount(bribeVotingReward, address(TENEX), TOKEN_1 * 2);
        ...
        // simulate rebases for epoch 0
        deal(address(TENEX), address(distributor), TOKEN_1);
        ...
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId), 0);
        ...
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId), TOKEN_1 / 2);
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId2), TOKEN_1 / 2);

        // epoch 1:
        // simulate rebase + non-compounded TENEX rewards
        ...
        uint256 pre = TENEX.balanceOf(address(owner4));
        vm.prank(address(voter));
        bribeVotingReward.getReward(mTokenId, rewards);
        uint256 post = TENEX.balanceOf(address(owner4));
        ...
        TENEX.approve(address(freeManagedReward), TOKEN_1 * 2);
        freeManagedReward.notifyRewardAmount(address(TENEX), ((TOKEN_1 * 2) * 3) / 4);
        vm.stopPrank();
        ...
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId), TOKEN_1 / 2);
        assertEq(freeManagedReward.earned(address(TENEX), tokenId), 0);
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId2), TOKEN_1 / 2);
        assertEq(freeManagedReward.earned(address(TENEX), tokenId2), 0);
        ...
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId), TOKEN_1);
        assertEq(freeManagedReward.earned(address(TENEX), tokenId), ((TOKEN_1 * 2) * 3) / 4 / 2);
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId2), TOKEN_1);
        assertEq(freeManagedReward.earned(address(TENEX), tokenId2), ((TOKEN_1 * 2) * 3) / 4 / 2);
        ...
        assertEq(TENEX.balanceOf(address(lockedManagedReward)), TOKEN_1 * 2);
        ...
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId2), 0);
        assertEq(freeManagedReward.earned(address(TENEX), tokenId2), ((TOKEN_1 * 2) * 3) / 4 / 2);
        ...
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId), 0);
        assertEq(TENEX.balanceOf(address(lockedManagedReward)), 0);
        ...
        // create TENEX bribe for epoch 4
        _createBribeWithAmount(bribeVotingReward, address(TENEX), TOKEN_1);

        skipToNextEpoch(1);

        // test normal nft behavior post withdrawal
        // ~= approx TOKEN_1 * 3 / 4, some drift due to voting power decay
        assertEq(bribeVotingReward.earned(address(TENEX), tokenId), 749095271054930289);
    ...
    function testTransferManagedNftFlow() public {
        ...
        vm.startPrank(address(owner4));
        TENEX.approve(address(freeManagedReward), TOKEN_1 * 2);
        freeManagedReward.notifyRewardAmount(address(TENEX), TOKEN_1);
        vm.stopPrank();
        ...
        assertEq(freeManagedReward.earned(address(TENEX), tokenId), TOKEN_1 / 2);
        assertEq(freeManagedReward.earned(address(TENEX), tokenId2), TOKEN_1 / 2);
        ...
        // collect rewards from bribe
        pre = TENEX.balanceOf(address(owner3));
        vm.prank(address(voter));
        bribeVotingReward.getReward(mTokenId, rewards);
        post = TENEX.balanceOf(address(owner3));
        assertEq(post - pre, TOKEN_1 * 2);

        // distribute reward to managed nft depositors
        vm.startPrank(address(owner3));
        TENEX.approve(address(freeManagedReward), TOKEN_1 * 2);
        freeManagedReward.notifyRewardAmount(address(TENEX), TOKEN_1 * 2);
        vm.stopPrank();
        ...
        assertEq(freeManagedReward.earned(address(TENEX), tokenId), TOKEN_1 / 2);
        assertEq(freeManagedReward.earned(address(TENEX), tokenId2), (TOKEN_1 * 5) / 2);
    ...
    function testManagedNftRebaseFlow() public {
        ...
        TENEX.approve(address(escrow), TOKEN_1M);
        ...
        assertGt(TENEX.balanceOf(address(distributor)), 0);
        ...
        assertEq(TENEX.balanceOf(address(lockedManagedReward)), managedRebaseTotal);
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId), 0);
        assertEq(escrow.supply(), supply);

        // epoch 3: claim rebases
        skipToNextEpoch(1);
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId), managedRebaseTotal);
        minter.updatePeriod();
        ...
        assertEq(lockedManagedReward.earned(address(TENEX), tokenId), managedRebaseTotal - rebase);
        assertEq(escrow.supply(), supply);
